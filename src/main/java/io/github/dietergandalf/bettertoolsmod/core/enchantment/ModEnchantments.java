...
public class ModEnchantments {
  ...
  public static final RegistryObject<Enchantment> RAMMUS_SHIELD = ENCHANTMENTS.register("protectionthorn", () -> new ProtectionThorn(Enchantment.Rarity.UNCOMMON, EnchantmentCategory.ARMOR_CHEST, EquipmentSlot.CHEST));
